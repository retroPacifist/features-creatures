...
import retropacifist.featuresandcreatures.client.model.ShulkrenYounglingModel;
import retropacifist.featuresandcreatures.common.entity.ShulkrenYounglingImpl;
import software.bernie.geckolib3.geo.render.built.GeoBone;
import software.bernie.geckolib3.renderers.geo.GeoEntityRenderer;

public class ShulkrenYounglingRenderer extends GeoEntityRenderer<ShulkrenYounglingImpl> {
    ...
    @Override
    public ResourceLocation getTextureLocation(ShulkrenYounglingImpl p_110775_1_) {
