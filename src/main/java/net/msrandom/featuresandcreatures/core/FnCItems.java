...
public class FnCItems {
    ...
    public static final RegistryObject<Item> SPEAR_ITEM = REGISTRAR.register("spear", () -> new SpearItem(new Item.Properties().durability(200).tab(TAB).setISTER(() -> SpearRenderer::new)));
}
