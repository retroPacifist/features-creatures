...
public class FnCEntities {
    ...
    public static final RegistryObject<EntityType<Jockey>> JOCKEY = createEntity("jockey", EntityType.Builder.of(Jockey::new, EntityClassification.CREATURE).sized(0.2f, 0.3f), 0xDBA5FF, 0x564237);
