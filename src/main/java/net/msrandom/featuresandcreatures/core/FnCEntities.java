...
public class FnCEntities {
    ...
    public static final RegistryObject<EntityType<Boar>> BOAR = createMobEntity("boar", EntityType.Builder.of(Boar::new, EntityClassification.CREATURE).sized(0.9F, 0.9F), 0x705F44, 0xFFF05A);
