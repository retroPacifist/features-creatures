...
public class FnCEntities {
    ...
    public static final EntityType<Spear> SPEAR = createEntity("spear", EntityType.Builder.<Spear>of(Spear::new, EntityClassification.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20));
    ...
    private static <T extends Entity> EntityType<T> createMobEntity(String name, EntityType.Builder<T> builder, int colour1, int colour2) {
        ...
        FnCItems.REGISTRAR.add(name + "_spawn_egg", new SpawnEggItem(type, colour1, colour2, new Item.Properties().tab(FnCItems.TAB)));
