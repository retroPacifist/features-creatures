...
import retropacifist.featuresandcreatures.reg.BlockRegistryObject;
...
public class FeaturesCreaturesBlocks {
    public static final RegistrationProvider<Block> REGISTER = RegistrationProvider.get(Registry.BLOCK, FeaturesAndCreatures.MOD_ID);
