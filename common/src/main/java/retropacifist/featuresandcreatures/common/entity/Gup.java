...
public class Gup extends PathfinderMob implements IAnimatable {
    ...
    protected void registerGoals() {
        this.goalSelector.addGoal(1, new GupFloatGoal(this));
        this.goalSelector.addGoal(3, new GupRandomDirectionGoal(this));
        this.goalSelector.addGoal(5, new GupKeepOnJumpingGoal(this));
    ...
    public static boolean checkSpawnRules(EntityType<Gup> type, LevelAccessor world, MobSpawnType spawnType, BlockPos pos, Random random) {
        if (world.getDifficulty() != Difficulty.PEACEFUL) {
            ...
            if (biomeCategory != Biome.BiomeCategory.THEEND && biomeCategory != Biome.BiomeCategory.NETHER && !biome.is(Biomes.SWAMP) && world.getMoonBrightness() == 0.0F) {
    ...
    static class GupFloatGoal extends Goal {
        ...
        public void tick() {
            ...
            ((GupMoveControl) this.gup.getMoveControl()).setWantedMovement(1.2D);
        }
    }
    ...
    static class GupKeepOnJumpingGoal extends Goal {
        ...
        public void tick() {
            ((GupMoveControl) this.gup.getMoveControl()).setWantedMovement(1.0D);
        }
    }
    ...
    static class GupRandomDirectionGoal extends Goal {
        ...
        public void tick() {
            ...
            ((GupMoveControl) this.gup.getMoveControl()).setDirection(this.chosenDegrees, false);
        }
    }
    ...
    static class GupLookAtTargetGoal extends Goal {
        ...
        public void tick() {
            ...
            ((GupMoveControl) this.gup.getMoveControl()).setDirection(this.gup.getYRot(), true);
        }
    }
